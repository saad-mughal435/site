...
const PROJECTS = [{
  ...
  desc: /*#__PURE__*/React.createElement(Fragment, null, "A low-latency ", /*#__PURE__*/React.createElement("strong", null, "C++17"), " engine that reconstructs a live limit-order book from the real ", /*#__PURE__*/React.createElement("strong", null, "NASDAQ TotalView-ITCH 5.0"), " feed. ITCH is order-based and already matched, so this is a ", /*#__PURE__*/React.createElement("strong", null, "reconstructor, not a matching engine"), " - the hot path is an O(1) ", /*#__PURE__*/React.createElement("code", null, "order_ref \u2192 order"), " map. It deframes real BinaryFILE captures and reconstructs every symbol in the stream; a pluggable adapter runs the same engine against ", /*#__PURE__*/React.createElement("strong", null, "MetaTrader 5"), " (live ticks in / orders out)."),
  bullets: [/*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "ITCH 5.0 decoder + real data"), " - manual big-endian field extraction (never a packed-struct cast over the wire); deframes real ", /*#__PURE__*/React.createElement("strong", null, "BinaryFILE"), " captures and routes every message to a per-symbol book by ", /*#__PURE__*/React.createElement("code", null, "stock_locate")), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Lock-free pipeline"), " - a wait-free SPSC ring (power-of-two mask, ", /*#__PURE__*/React.createElement("code", null, "alignas(64)"), " cache-line split) feeds a decode thread \u2192 book thread, parity-tested and ", /*#__PURE__*/React.createElement("strong", null, "validated race-free by ThreadSanitizer"), " in CI"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Pluggable book, measured"), " - the reconstructor is templated over its price-level store (a ", /*#__PURE__*/React.createElement("code", null, "std::map"), " baseline vs a cache-friendly flat sorted vector) and benchmarked head-to-head with Google Benchmark; ", /*#__PURE__*/React.createElement("code", null, "obreplay"), " prints throughput + a p50 / p99 / p99.9 latency histogram"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "MetaTrader 5 bridge"), " - versioned NDJSON over TCP, an ", /*#__PURE__*/React.createElement("code", null, "ITCHBridge.mq5"), " EA, and a depth publisher that streams the reconstructed book back; a mock-client integration test runs the full ticks \u2192 orders \u2192 acks round trip in CI without Windows"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Hardened & verified"), " - every push runs ThreadSanitizer, Address / UB sanitizers, a ", /*#__PURE__*/React.createElement("strong", null, "libFuzzer"), " decode harness and a clang ", /*#__PURE__*/React.createElement("code", null, "-Werror"), " build alongside ", /*#__PURE__*/React.createElement("code", null, "ctest"), " and a benchmark smoke")],
  tags: ['C++17', 'HFT', 'NASDAQ ITCH 5.0', 'Lock-free', 'Low-latency', 'Market data', 'Multi-symbol', 'MetaTrader 5', 'Benchmarked', 'Sanitized + fuzzed', 'CMake', 'Catch2', 'GitHub Actions'],
  ctas: [{
