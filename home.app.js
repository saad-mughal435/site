...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    target: "_blank",
    rel: "noopener"
  }, "L2 viewer \u2197"), ")")), /*#__PURE__*/React.createElement("div", {
    className: "hero-meta"
...
const PROJECTS = [{
  ...
  domain: 'code',
  kind: 'C++17 HFT engine · ITCH 5.0 · MoldUDP64 · FIX 4.4 · MT5 · CI',
  year: '2026',
  ...
  desc: /*#__PURE__*/React.createElement(Fragment, null, "A low-latency ", /*#__PURE__*/React.createElement("strong", null, "C++17"), " trading-infrastructure engine. It reconstructs limit-order books from the real ", /*#__PURE__*/React.createElement("strong", null, "NASDAQ TotalView-ITCH 5.0"), " feed - over ", /*#__PURE__*/React.createElement("strong", null, "BinaryFILE"), " captures and the ", /*#__PURE__*/React.createElement("strong", null, "MoldUDP64"), " UDP multicast transport - derives microstructure signals, scales across cores, speaks ", /*#__PURE__*/React.createElement("strong", null, "FIX 4.4"), " order entry and a ", /*#__PURE__*/React.createElement("strong", null, "MetaTrader 5"), " bridge, and can be ", /*#__PURE__*/React.createElement("strong", null, "watched reconstructing the book in the browser"), " (a synthetic ITCH session replayed through the real engine; point it at a live wsbook feed with ", /*#__PURE__*/React.createElement("code", null, "?ws="), "). ITCH is pre-matched, so this is a ", /*#__PURE__*/React.createElement("strong", null, "reconstructor, not a matching engine"), " - the hot path is an O(1) ", /*#__PURE__*/React.createElement("code", null, "order_ref \u2192 order"), " map."),
  bullets: [/*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Market connectivity"), " - ITCH 5.0 decode by manual big-endian byte assembly (never a packed-struct cast over the wire); reads real ", /*#__PURE__*/React.createElement("strong", null, "BinaryFILE"), " files and the ", /*#__PURE__*/React.createElement("strong", null, "MoldUDP64"), " UDP feed with ", /*#__PURE__*/React.createElement("strong", null, "sequence-gap detection"), "; routes every message to a per-symbol book by ", /*#__PURE__*/React.createElement("code", null, "stock_locate")), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Lock-free, sub-microsecond, sharded"), " - a wait-free SPSC ring (", /*#__PURE__*/React.createElement("code", null, "alignas(64)"), " cache-line split, ", /*#__PURE__*/React.createElement("code", null, "PAUSE"), " busy-wait) feeds a decode \u2192 book pipeline in well under 100\xA0ns/msg; symbols shard across pinnable worker threads, one ring each - all ", /*#__PURE__*/React.createElement("strong", null, "validated race-free by ThreadSanitizer")), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Pluggable book, measured"), " - templated over its price-level store: a ", /*#__PURE__*/React.createElement("code", null, "std::map"), " baseline, a flat sorted vector, and a ", /*#__PURE__*/React.createElement("strong", null, "price-tick-indexed windowed array"), " (the canonical L2 structure, ~24% faster in the A/B) - all three parity-tested and benchmarked head-to-head with Google Benchmark"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Microstructure signals + browser viewer"), " - micro-price, order-book imbalance and spread (bps) plus a trade tape with VWAP / OHLCV, streamed as JSON over a ", /*#__PURE__*/React.createElement("strong", null, "dependency-free WebSocket"), " (hand-rolled SHA-1 + RFC-6455 frame codec) to a browser L2 book viewer"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "FIX 4.4 order entry"), " - a compact FIX codec (NewOrderSingle / ExecutionReport) with auto BodyLength + CheckSum: the order-entry counterpart to the ITCH market-data side (market data in, orders out)"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "MetaTrader 5 bridge"), " - versioned NDJSON over TCP, an ", /*#__PURE__*/React.createElement("code", null, "ITCHBridge.mq5"), " EA, and a depth/signal publisher that streams the reconstructed book back; a mock-client integration test runs the full ticks \u2192 orders \u2192 acks round trip in CI without Windows"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Hardened & verified"), " - every push runs ThreadSanitizer, Address / UB sanitizers, a ", /*#__PURE__*/React.createElement("strong", null, "libFuzzer"), " decode harness and a clang ", /*#__PURE__*/React.createElement("code", null, "-Werror"), " build alongside ", /*#__PURE__*/React.createElement("code", null, "ctest"), " and a benchmark smoke")],
...
const DEMO_PROJECTS = [{
  ...
  desc: /*#__PURE__*/React.createElement(Fragment, null, "A UAE short-stay booking marketplace demo: 55 homes across 10 destinations, a hand-rolled date-range picker and availability calendar with conflict-check, per-night pricing with weekend surcharge and 5% VAT, and an 11-section admin SPA - plus a host listing wizard with a manual approval queue."),
  bullets: [/*#__PURE__*/React.createElement(Fragment, null, "Hand-rolled ", /*#__PURE__*/React.createElement("strong", null, "date-range picker"), " + availability calendar (no library) with blocked / booked / available states"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Conflict-check booking flow"), ": POST /bookings returns 409 if dates were just taken; UI bounces back with a toast"), /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("strong", null, "Host-side: 6-step listing wizard"), " (save-and-resume drafts, map-pin selector, document upload - Emirates ID + ownership + DTCM permit + IBAN) feeding an ", /*#__PURE__*/React.createElement("strong", null, "admin verification queue"), " for manual approval; listings stay off-market until live"), /*#__PURE__*/React.createElement(Fragment, null, "9 guest pages + 11-section admin SPA + host dashboard: dashboard, listings (CRUD + bulk + status pipeline + CSV), bookings, hosts (Superhost verify), guests, reviews, payments/payouts, promotions, destinations, ", /*#__PURE__*/React.createElement("strong", null, "host approvals + listing approvals (approve / request-changes / reject)"), ", settings, audit"), /*#__PURE__*/React.createElement(Fragment, null, "Full pricing breakdown: nightly subtotal \xD7 nights + weekend surcharge + cleaning + 10% service fee + 5% VAT")],
...
const SKILLS = [{
  domain: 'code',
  title: 'Backend & APIs',
  items: ['Python', 'FastAPI', 'Java', 'Spring Boot', 'Spring Data JPA', 'C++17', 'Lock-free', 'Low-latency', 'Market data', 'Market microstructure', 'FIX protocol', 'UDP multicast', 'TypeScript', 'Node.js', 'REST APIs', 'JWT Auth', 'OpenAPI / Swagger', 'Pydantic', 'async I/O']
}, {
  domain: 'all',
