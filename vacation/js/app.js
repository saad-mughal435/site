...
(function () {
  ...
  function footHtml() {
    return ''
      ...
      +         '<p style="color:rgba(255,255,255,.6);margin-top:8px;max-width:340px;">A UAE short-stay booking demo. 54 vacation homes across 10 destinations - Marina, Palm, Hatta, RAK, Fujairah, Liwa and more. Book by the night.</p>'
  ...
  function listingCard(l, opts) {
    ...
    return ''
      ...
      +       '<span>🛏 ' + (l.bedrooms === 0 ? 'Studio' : l.bedrooms + 'BR') + '</span>'
