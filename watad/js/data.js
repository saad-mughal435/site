...
(function () {
  ...
  WORK_ORDERS.push({ id: 'wo-12', wo_no: woNo(), title: 'Replace FCU-L1-02 valve actuator', asset_id: 'as-fcu-l1-2', priority: 'med', assignee_id: 'st-noura', status: 'completed', created_at: isoAgo(60 * 168), due: isoAgo(60 * 120), description: 'Stuck actuator on FCU. Belimo replacement installed.', parts: ['Belimo TR24-3'], comments: [{ at: isoAgo(60 * 125), by: 'st-noura', body: 'Replaced and commissioned.' }] });
