...
A fast, accessible, dark-themed portfolio with **nine** interactive demos
— including an MES/ERP walkthrough, a DTC storefront, a B2B wholesale
portal, a Dubai real-estate marketplace, a UAE short-stay booking
platform, a café POS with KDS, an AI customer-support copilot, a
smart-building / BMS operations console with real-time telemetry, and a
**mobile-first AI journaling PWA** installable to your phone's home
screen — plus an **AI chatbot on the homepage** that answers recruiter
questions grounded in the site's content, structured data for search
engines, and a working contact form.
