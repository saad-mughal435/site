...
A fast, accessible, dark-themed portfolio with **eight** interactive demos
...
KDS, an AI customer-support copilot, and a smart-building / BMS operations
console with real-time telemetry), an **AI chatbot on the homepage** that
answers recruiter questions grounded in the site's content, structured
data for search engines, and a working contact form.
